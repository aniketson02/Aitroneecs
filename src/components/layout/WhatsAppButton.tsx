...
export function WhatsAppButton() {
  return (
    <a
      ...
      className="group fixed bottom-5 right-5 z-40 flex items-center gap-0 rounded-full bg-[#25D366] p-3.5 text-white shadow-lg shadow-black/20 transition-all duration-300 hover:gap-2 hover:pr-5"
    >
